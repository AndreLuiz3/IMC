...
function imc () {
    ...
    if (nome !== '' && altura !== '' && peso !== '') {
        ...
        resultado.textContent = `Olá, ${nome}! Com ${peso}kg e ${altura}m, seu IMC é ${valorIMC}. Atualmente, você está ${classificacao}. Seu peso ideal é entre ${pesominimo}kg e ${pesomaximo}kg.`;
